  ...
  return (
    <footer className="footer-container">
      <div className="footer-link-container">
        <div>
          <img className="footer-logo" src="./img/logo.png" alt="Ryan Malone" />
        </div>
        ...
        <div className="footer-social-icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/ryan.malonee/"
            ...
            <li>
              <a
                href="https://www.instagram.com/ryan.malonee/"
                className="navbar-content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://twitter.com/ryanmalonee"
                className="navbar-content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/ryan-malone-b59800181/"
                className="navbar-content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer-content-container">
        <p className="footer-content">
          Crafted by Ryan Malone | Template and Tutorial Provided by{" "}
          <a
            className="attribute-link"
            href="https://www.youtube.com/watch?v=g0HKvRj84Ak&ab_channel=HowtoBecomeaDeveloper"
            target="_blank"
          >
            John and Figma Designs
          </a>
        </p>
      </div>
    </footer>
